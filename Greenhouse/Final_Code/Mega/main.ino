...
void sendData() {
    ...
    sensorDoc["inner_tank_volume"] = random(0, 3500) / 10.0;  
    sensorDoc["outer_tank_volume"] = random(0, 3500) / 10.0;
    sensorDoc["soil_tank_volume"] = random(0, 40) / 10.0;
...
//     digitalWrite(fanPin, pinD12);
//     digitalWrite(heaterPin, pinD13);
